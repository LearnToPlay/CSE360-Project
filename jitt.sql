...
--
-- Host: localhost
-- Generation Time: Apr 21, 2012 at 06:09 PM
...
('Quiz 1', 'CSE-360', '2012-04-16 18:12:39', '2012-04-16 19:31:45');
...
CREATE TABLE IF NOT EXISTS `quiz_response` (
  ...
  PRIMARY KEY (`quiz`,`course`,`username`,`question_num`),
...
('Quiz 1', 'CSE-360', 'betty', 1, 'C'),
('Quiz 1', 'CSE-360', 'betty', 2, 'C'),
('Quiz 1', 'CSE-360', 'betty', 3, 'C'),
